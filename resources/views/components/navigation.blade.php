<nav class="bg-gray-800" x-data="{open:false}">
      ...
      <div class="relative flex items-center justify-between h-16">
        ...
        <div class="flex-1 flex items-center sm:items-stretch justify-start">
          ...
          <a href="" class="flex-shrink-0 flex items-center">
            <img class="ml-12 lg:ml-0 block h-8 w-auto" src="https://tailwindui.com/img/logos/workflow-logo-indigo-500-mark-white-text.svg" alt="Workflow">
          </a>
          <div class="hidden sm:block sm:ml-6">
              {{--Menu lg--}}
            <div class="flex space-x-4">
              <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
              <a href="{{route('alumnos')}}" class="bg-gray-900 text-white px-3 py-2 rounded-md text-sm font-medium">Alumnos</a>
              <a href="" class="bg-gray-900 text-white px-3 py-2 rounded-md text-sm font-medium">Usaer</a>
        ...
        <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
          ...
          <div class="ml-3 relative" x-data="{open:false}">
            ...
            <div x-show="open" x-on:click.away="open = false" class="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5" role="menu" aria-orientation="vertical" aria-labelledby="user-menu">
              ...
              <a href="{{route('admin.home')}}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">Administración</a>  
    ...
    <div class="sm:hidden" id="mobile-menu" x-show="open"  x-on:click.away="open = false">
      <div class="px-2 pt-2 pb-3 space-y-1">
        <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
        <a href="{{route('alumnos')}}" class="bg-gray-900 text-white block px-3 py-2 rounded-md text-base font-medium">Alumnos</a>
        <a href="#" class="bg-gray-900 text-white block px-3 py-2 rounded-md text-base font-medium">Usaer</a>
      </div>
    </div>
  </nav>